...
class WebSubMenuController extends Controller
{
    ...
    public function index(){
        $submenu = WebSubMenu::latest()->paginate(15);
    ...
    public function destroy(WebSubMenu $webSubMenu){
        $webSubMenu->delete();
        return response()->json(['message','Web Sub Menu deleted successfully',200]);
    }

    public function search($query){
        return new WebSubMenuCollection(WebSubMenu::Where('name', 'like', "%$query%")->paginate(10));
    }
}

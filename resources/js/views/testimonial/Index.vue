                ...
                <div class="table-responsive">
                  <table class="table table-bordered table-striped dt-responsive nowrap dataTable no-footer dtr-inline table-sm small">
                    ...
                    <tr v-for="(testimonial, i) in testimonials" :key="testimonial.id" v-if="testimonials.length">
                      ...
                      <td class="text-center">
                        <router-link :to="`testimonial-details/${testimonial.id}`" class="btn btn-primary btn-sm btn-xs"><i class="far fa-eye"></i></router-link>
...
export default {
  ...
  mounted() {
    document.title = 'Testimonial List | Baitulaman';
    this.getAllTestimonial();
  },
  methods: {
    getAllTestimonial(){
